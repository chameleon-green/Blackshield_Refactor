...
if ( (MyDisplacement > -156) and (MyDisplacement < 133) ){
	
	Interactable = 1;
	
	draw_self();	
	draw_text_ext_transformed_color(x,y+(7*scale),item.name,1,99999,scale*0.8,scale*0.9,0,Color,Color,Color,Color,1);
...
//top cutoff
if ( (MyDisplacement > 133) and (MyDisplacement < 166) ){
